    ...
    describe('throws on invalid model declarations', function () {
        ...
        it('correctly throws an error when a model does not have a modelName property', function () {
            var A = function (_Model7) {
                (0, _inherits3.default)(A, _Model7);
